...
xref:scaffolding-and-rest.adoc#scaffolding-and-rest["Scaffolding and REST"] we came
...
In the section xref:routing.adoc#parameters["Parameters"] I showed you how
...
xref:first-steps-with-rails.adoc#creating-html-dynamically-with-erb["Scaffolding and
