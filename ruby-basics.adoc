...
NOTE: If your system runs an older version and you want to upgrade it
      ...
      xref:installing.adoc#installing[the install appendix] for a
      step-by-step guide.
...
detail in xref:ruby-basics.adoc#class-methods-and-instance-methods[the section called
...
xref:ruby-basics.adoc#arrays[the section called "Arrays"]).
