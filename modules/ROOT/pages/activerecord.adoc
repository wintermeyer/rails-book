...
ActiveRecord provided link:https://wintermeyer-consulting.de/ruby/book/classes.html#getters-and-setters[getters and setters].
...
link:https://wintermeyer-consulting.de/ruby/book/loops.html#iterators[iterators] and link:https://wintermeyer-consulting.de/ruby/book/arrays.html#iterator-each[each],
...
You can also use `where` to search for link:https://wintermeyer-consulting.de/ruby/book/ranges.html#ranges[ranges]:
