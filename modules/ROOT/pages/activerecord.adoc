...
ActiveRecord provided xref:ruby-basics.adoc#getters-and-setters[getters and setters].
...
xref:ruby-basics.adoc#iterators[iterators] and xref:ruby-basics.adoc#iterator-each[each],
...
You can also use `where` to search for xref:ruby-basics.adoc#range[ranges]:
