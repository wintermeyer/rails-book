...
xref:scaffolding-and-rest.adoc#scaffolding-and-rest["Scaffolding and REST"] first)
...
xref:test-driven-development.adoc#example-for-a-user-in-a-web-shop["Example for a
