...
Alter on we are going to dive more into xref:routing.adoc#routing[Routes].
...
xref:ruby-basics.adoc#irb[section "irb"]) built around
...
In xref:activerecord.adoc#activerecord[chapter "ActiveRecord"] we
